...
class Window(QWidget, QObject):
    ...
    def init_ui(self):
        ...
        #position = self.slider.sliderMoved       
        ...
        #current_position = self.slider.valueChanged
        #print(current_position)
        #self.signals.result.emit(current_position)
    ...
    def set_position(self, position):
        ...
        self.signals.result.emit(position)
        print(position)
        return current_position
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.signals = WorkerSignals()
        self.signals.result.connect(self.display)
    ...
    def display(self):
        import pdb; pdb.set_trace()
        print("Slider value received no is %d", self.position)
    ...
    def update_plot_data(self):
        ...
        #self.position = WinObj.set
         
        self.WinObj.signals.result.connect(self.display)
        ...
        #print("Slide value is %d", slide_value)
        self.time_iter = self.time_iter + 1
        #xx = np.array(self.cursor_x)
        #yy = np.array(self.cursor_y)
        #self.data_line1.setData(xx, yy)

        #self.pool.start(self.WinObj)
